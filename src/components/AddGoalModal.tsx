  ...
  const handleSave = () => {
    ...
    if (dueDisplay.length > 0) {
      if (dueDisplay.replace(/[^0-9]/g, "").length !== 8) {
        Alert.alert("Incomplete Date", "Please finish entering the date (MM-DD-YYYY).");
        return;
      }
      ...
      <View style={styles.overlay}>
        <View style={[styles.container, { backgroundColor: theme.bg }]}>
          <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
                ...
                <Pressable
                  ...
                  style={[
                    ...
                    { 
                      ...
                      borderColor: color === swatch ? theme.text : "transparent",
            ...
            {/* DATE */}
            <Text style={[styles.label, { color: theme.text }]}>Target Date (Optional)</Text>
            <TextInput
              value={dueDisplay}
              ...
              style={[styles.input, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.text }]}
            />
            <Text style={{ fontSize: 11, color: theme.placeholder, marginTop: -4, marginBottom: 24 }}>
              Format: MM-DD-YYYY
            </Text>
            ...
            {isEditing && (
              ...
              >
                <Text style={[styles.buttonText, { color: "#FFFFFF" }]}>Delete Goal</Text>
              </Pressable>
            )}
